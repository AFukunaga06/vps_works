...
-- ユーザー（弁護士・スタッフ）
-- 認証は login_id（ログインID）で行う。email は連絡先用。
...
-- 初期管理者アカウント（ログインID: admin / パスワード: admin123）
INSERT IGNORE INTO lc_users (login_id, name, email, password_hash, role)
VALUES ('admin', '管理者', 'admin@example.com',
        'REDACTED_PASSWORD_HASH', 'admin');

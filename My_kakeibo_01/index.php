...
<head>
  ...
  <style>
    ...
    tbody tr:hover td:nth-child(3) { background: #bfdbfe; }
      ...
      <div class="form-split">
        ...
        <div class="form-left">
          ...
          <div>
            ...
            <input type="number" id="withdrawal" step="1" placeholder="例: 850" />
          </div>

          <div>
            <label for="charge">チャージ額</label>
            <input type="number" id="charge" step="1" placeholder="例: 10000" />
          </div>

          <div>
            <label for="deposit">入金額</label>
            <input type="number" id="deposit" step="1" placeholder="例: 5000" />
          </div>
        </div>

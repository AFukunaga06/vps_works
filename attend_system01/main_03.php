...
<div class="main">
    ...
    <a href="index_02d.php" class="btn green">土曜出勤</a>
    <a href="report.php" class="btn orange">レポート（日計・月計・年計）</a>
    <a href="backup.php" class="btn gray">💾 バックアップ管理</a>
    <a href="logout.php" class="btn" style="background:#f9a825;">ログアウト</a>
</div>
</body>
</html>

...
// ページ内の「選択中の日付」を取り出す関数
function getSelectedDateISO(){
  return window.selectedDateISO || "";
}
...
function getAllCheckboxes(){
  return Array.from(document.querySelectorAll('input[type="checkbox"][data-gender][data-name]'));
}
...
async function saveAttendanceToDB(){
  ...
  const items = getAllCheckboxes().map(cb => ({

          ...
          <div class="card-body">
            ...
            <div class="notice-box">
              ...
              <ul class="check-list mt-1">
                <li>当窓口は、法律問題の整理や相談準備のサポートを行うものです。</li>
                <li>個別案件に対する法的判断（勝てる/負ける等の断定）、代理交渉、訴訟対応、法律文書の代理作成等は行いません。</li>
                <li>必要に応じて、弁護士・司法書士・公的機関などへの相談をおすすめする場合があります。</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <table class="table table-bordered price-table table-sm">
          ...
          <tbody>
            <tr>
              ...
              <td>初回<strong>無料</strong><br><small>2回目以降 45分 1,500円（税込）</small></td>
            </tr>
          </tbody>
        </table>
      </div>

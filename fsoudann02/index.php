...
<title>ABC○○法律事務所相談窓口（初回無料）</title>
...
<div class="site-header">
  ...
  <div class="mt-4">
    ...
    <a href="qa/index.php" class="btn-reserve" style="background:rgba(255,255,255,.15);color:#fff;border:2px solid rgba(255,255,255,.7);margin-left:.75rem;">AI法律Q&amp;A</a>
  </div>
</div>
...
<div class="container py-2" style="max-width: 860px;">
          ...
          <div class="card-body">
            ...
            <div class="price-box">
              ...
              <ul class="example-list">
                ...
                <li>2回目以降：45分 3,000円（税込）4回まで相談可</li>
                <li>前払い制</li>
              </ul>
            </div>
  ...
  <!-- ===== よくある質問 ===== -->
  <div class="section">
    <div class="section-title">よくある質問（Q&amp;A）</div>
    <div class="accordion" id="faqAccordion">
      ...
      <div class="accordion-item border mb-2 rounded">
        ...
        <div id="faq1" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
          <div class="accordion-body small">
            A. 初回は30〜45分の相談整理サポートを無料で行います。お困りの状況をうかがい、問題点の整理・次にやることのリストアップを行います。費用は一切かかりません。ただし事前予約が必要です。
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item border mb-2 rounded">
        <h2 class="accordion-header">
          <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq2">
            Q. 弁護士に直接相談することはできますか？
          </button>
        </h2>
        <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
          <div class="accordion-body small">
            A. 当窓口は弁護士への相談前の「整理サポート」を行う窓口です。具体的な法的対応（交渉・訴訟など）は弁護士が担当します。必要な場合は弁護士との委任契約についてご案内します。
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item border mb-2 rounded">
        <h2 class="accordion-header">
          <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq3">
            Q. Zoom・電話・対面、どれで相談できますか？
          </button>
        </h2>
        <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
          <div class="accordion-body small">
            A. Zoom・電話・対面のいずれかをお選びいただけます。ご予約時にご希望の方法をお知らせください。
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item border mb-2 rounded">
        ...
        <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
          <div class="accordion-body small">
            A. 前払い制です。ご予約受付後に振込先等をご案内しますので、入金確認後に予約確定となります。当日キャンセルは原則返金不可ですのでご注意ください。
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item border mb-2 rounded">
        ...
        <div id="faq5" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
          <div class="accordion-body small">
            A. 法律相談（相談前整理サポート）は初回無料を含め、最大4回まで相談いただけます。
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item border mb-2 rounded">
        <h2 class="accordion-header">
          <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#faq6">
            Q. どんな相談でも受け付けてもらえますか？
          </button>
        </h2>
        <div id="faq6" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
          <div class="accordion-body small">
            A. 相続・遺言・家族間トラブル・契約・請求に関するお困りごとなど、幅広くお受けしています。まずはお気軽にご相談内容の概要をお知らせください。
          </div>
        </div>
      </div>
  ...
  <div class="section">
    ...
    <div class="row g-4">
        ...
        <table class="table table-bordered price-table table-sm">
          ...
          <tbody>
            <tr>
              ...
              <td>初回<strong>無料</strong><br><small>2回目以降 45分 3,000円（税込）4回まで相談可</small></td>
            </tr>
          </tbody>
        </table>
      </div>
      <div class="col-md-6">
        ...
        <ul class="check-list">
          <li>前払い制です。</li>
          <li>振り込みの場合：ABC銀行 ○○支店 普通 口座番号○○ 口座名義○○</li>
          <li>但し対面の場合は現金払い可</li>
  ...
  <div class="section pb-1">
    <div class="message-box">
      <h2 class="h5 mb-3" style="color:#a8e6c1">ABC○○法律事務所相談窓口からのメッセージ</h2>
      <p>一人で抱え込んでしまうと、何から手をつければよいか分からなくなることがあります。</p>
      <p>ABC○○法律事務所相談窓口では、まずお話を丁寧にうかがい、状況を整理し、次に進むためのお手伝いをいたします。</p>
...
<footer>
  <p class="mb-0">ABC○○法律事務所相談窓口 &nbsp;|&nbsp; 初回無料</p>
</footer>
